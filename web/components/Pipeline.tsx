...
const AGENTS: (Box & { from: number[] })[] = [
  ...
  { x: 270, y: 174, w: 170, h: 26, title: "risk", sub: "volatility · drawdown brake", tone: "rule", from: [2] },
  { x: 270, y: 206, w: 170, h: 26, title: "macro", sub: "regime × beta (VIX, rates, trend)", tone: "rule", from: [2] },
